...
pages = [
    ...
    st.Page("pages/report_generator.py", title="Create Report", icon=":material/show_chart:", url_path="/generate_report"),
    st.Page("pages/report.py", title="View Report", icon=":material/show_chart:", url_path="report")
]
